...
<BODY BGCOLOR="#FFFFFF" TEXT="#000000" LINK="#FF0000" VLINK="#800000" ALINK="#FF00FF" BACKGROUND="?">
		...
		<div>
			...
			<ul class="pagination modal-2">	  
				...
				?>
				<li class="modal-2" title="Prev Set"><a href="blue_tables_pagination.php?page=<?php echo $prev_set ?>"><?php echo "Prev Set" ?></a></li>
				<?php if ($page == 0) { $page=1; }
				...
				<?php	} 
						elseif ($clicked_page == $page) { ?>
							<li class="page"><a class="active" href="blue_tables_pagination.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>
				<?php	}
					}				 					
				if ($page < $total_pages) {
					$page=$page+1;						
				...
				if ($page <= $max_tot_pages) { $page=$page+1; ?>
					<li class="modal-2" title="Next Set"><a href="blue_tables_pagination.php?page=<?php echo $page ?>"><?php echo "Next Set" ?></a></li>					
				<?php } ?>
			</ul>
			<?php } ?>
		</div>
